...
play(){
  ...
  //  hurdle1=createSprite(60,60,20,20);
    image(track,0,-displayHeight*4,displayWidth*3,displayHeight*5);
    hurdle1=createSprite(390,360,5,5);
    hurdle1.scale=0.2;
    hurdle1.addImage("hurdle1",hurdle1img);
    //var dp=130;
  var index=0;
  var x=240;
  var y=0;
